...
const odmInfo = require('./odmInfo.js');
    ...
    handleInit: (req, res) => {
        ...
        async.series([ 
            cb => {
                ...
                req.body.options = [{"name":"use-3dmesh","value":true},{"name":"texturing-single-material","value":true},{"name":"feature-quality","value":"low"},{"name":"skip-report","value":true}];

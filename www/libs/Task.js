...
module.exports = class Task{
    ...
    getProjectFolderPath(){
     ...
     getConvertScriptPath() {
        const convertScriptPath = path.join('convert.py');  
    ...
    getModelPath(){
        return path.join(this.getProjectFolderPath(), 'odm_meshing/odm_mesh.ply');
    }

    getModelPathTwo(){
        return path.join(this.getProjectFolderPath(), 'odm_texturing/odm_textured_model_geo.obj');
    }

    getModelImage(){
        return path.join(this.getProjectFolderPath(), 'odm_texturing/odm_textured_model_geo_material0000_map_Kd.png');
    }

    getModelFolderPath(){
        return path.join(this.getProjectFolderPath(), 'odm_meshing');
    }

    getModelFolderPathTwo(){
        return path.join(this.getProjectFolderPath(), 'odm_texturing');
    }
    ...
    async downloadModel() {
        ...
        const token = process.env.XRF_SERVICE_TOKEN; 
